...
<body bgcolor="#C92E01"><font face="Verdana" size="2" color="#FFFFFF">
 ...
 <div>
	<iframe name="chat" src="chat-mesa.php" width="100%" height="80%" frameborder="0">Atualize seu navegador.</iframe>
	<br>
</div>
<div>
...
<!--FORM DE FALA-->
<hr color="white"><form action="gravar-mesa.php" method="post" target="chat">
